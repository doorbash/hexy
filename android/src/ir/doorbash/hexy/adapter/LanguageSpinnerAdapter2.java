 ...
 */
public class LanguageSpinnerAdapter2 extends BaseAdapter {

    private Context context;
    public String[] array;

    public LanguageSpinnerAdapter2(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.row_dialog_settings2, null);
